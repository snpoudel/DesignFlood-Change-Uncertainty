...
#function to return percentage change in flood
    ...
    for grid in grid_list:
        for comb in range(15):
            ...
            if os.path.exists(file_path):
                ...
                change_hbv_recalib = pd.DataFrame({'station':basin_id,'model':'HBV Recalib', 'change_5yr_flood':percent_change(temp_df_hbvrf['5yr_flood'] , temp_df_hbvr['5yr_flood']),
                                'change_10yr_flood':percent_change(temp_df_hbvrf['10yr_flood'] , temp_df_hbvr['10yr_flood']),
                                'change_20yr_flood':percent_change(temp_df_hbvrf['20yr_flood'] , temp_df_hbvr['20yr_flood']), 'precip_rmse':precip_rmse}, index=[0])
                
                change_hymod = pd.DataFrame({'station':basin_id,'model':'Hymod', 'change_5yr_flood':percent_change(temp_df_hyf['5yr_flood'] , temp_df_hy['5yr_flood']),
                                'change_10yr_flood':percent_change(temp_df_hyf['10yr_flood'] , temp_df_hy['10yr_flood']),
                                'change_20yr_flood':percent_change(temp_df_hyf['20yr_flood'] , temp_df_hy['20yr_flood']), 'precip_rmse':precip_rmse}, index=[0])
                
                change_lstm = pd.DataFrame({'station':basin_id,'model':'LSTM', 'change_5yr_flood':percent_change(temp_df_lstmf['5yr_flood'] , temp_df_lstm['5yr_flood']),
                                'change_10yr_flood':percent_change(temp_df_lstmf['10yr_flood'] , temp_df_lstm['10yr_flood']),
                                'change_20yr_flood':percent_change(temp_df_lstmf['20yr_flood'] , temp_df_lstm['20yr_flood']), 'precip_rmse':precip_rmse}, index=[0])
