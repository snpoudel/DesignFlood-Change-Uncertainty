...
#SBATCH --ntasks=31                    #394 Number of tasks (one for each job), if you don't know numner of tasks beforehand there are ways to make this input dynamic as well
...
mpirun python3 2.3future_true_precip.py
