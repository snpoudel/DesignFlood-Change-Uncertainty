#!/bin/bash
#SBATCH --job-name=hym-lstm            # Job name
#SBATCH --output=hym-lstm%j.log       # Output file name (%j expands to jobID)
#SBATCH --error=hym-lstm%j.log        # Error file name (%j expands to jobID)
...
#SBATCH --mem=128G                        # Memory per CPU core (adjust as needed)
...
mpirun python3 3.7hymod_LSTM.py