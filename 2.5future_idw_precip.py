...
for i in stn['id']:
    ...
    precip_all_stations = pd.concat([precip_all_stations, temp_df], ignore_index=True)
...
def func_multiprocessing(grid_input):
        ...
        for comb in range(10):
            ...
            precip_df.to_csv(f'data/future/future_idw_precip/future_idw_precip{basin_id}_coverage{grid_input}_comb{comb}.csv', index=False)
