...
basin_list = pd.read_csv("data/regional_lstm_hymod/MA_basins_gauges_2000-2020_filtered.csv", dtype={'basin_id':str})['basin_id'].values
...
for basin_id in basin_list:
    file_path = f'data/regional_lstm_hymod/processed_lstm_input/pb0/lstm_input{basin_id}.csv'
...
for i in range(kfold): #use ith fold as validation set
    ...
    df.to_csv(f'output/lstm_tuning/residual_model/lstm_tuning_{iter}.csv', index=False)
