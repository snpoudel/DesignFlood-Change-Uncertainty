...
def calibNSE(station_id, grid, combination):
    ...
    algorithm_param = {
        ...
        'population_size': 2500, #150                # Number of parameter-sets in a single iteration/generation(to start with population 10 times the number of parameters should be fine!)
