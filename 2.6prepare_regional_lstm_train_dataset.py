...
for id in basin_list['basin_id']:
    for case in ['', 'future_']: #iterate over historical and future case
        ...
        previous_file.to_csv(f'data/regional_lstm/{case}processed_lstm_train_datasets/pb0/lstm_input{id}.csv', index=False)
            ...
            for comb in range(15):
                ...
                if os.path.exists(file_path):
                    ...
                    if precip_rmse < random_precip_rmse:
                        ...
                        #save the final lstm input file
                        previous_file.to_csv(f'data/regional_lstm/processed_lstm_train_datasets/pb{precip_bucket}/lstm_input{id}.csv', index=False)
            ...
            for comb in range(15):
                ...
                if os.path.exists(file_path):
                    ...
                    if precip_rmse < random_precip_rmse:
                        ...
                        #save the final lstm input file
                        previous_file.to_csv(f'data/regional_lstm/future_processed_lstm_train_datasets/pb{precip_bucket}/lstm_input{id}.csv', index=False)