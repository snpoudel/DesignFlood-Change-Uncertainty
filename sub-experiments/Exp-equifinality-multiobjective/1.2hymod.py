...
for combination in np.arange(12):
    ...
    if os.path.exists(file_path):
        ...
        # #save parameters
        # params_in.to_csv(f'/home/fs01/sp2596/MA-Precip-Uncertainty-Exp-equifinality2/output/parameters/hymod/params{id}_grid{grid}_comb{combination}.csv')
        params_in = pd.read_csv(f'/home/fs01/sp2596/MA-Precip-Uncertainty-Exp-equifinality2/output/parameters/hymod/params{id}_grid{grid}_comb{combination}.csv')
        ...
        # output_df.to_csv(f'/home/fs01/sp2596/MA-Precip-Uncertainty-Exp-equifinality2/output/hymod/hymod{id}_coverage{grid}_comb{combination}.csv')
        ...
        output_df = pd.DataFrame({ 'date':precip_in['DATE'], 'streamflow':q_sim })
        #save output dataframe
        output_df.to_csv(f'/home/fs01/sp2596/MA-Precip-Uncertainty-Exp-equifinality2/output/future/hymod/hymod{id}_coverage{grid}_comb{combination}.csv')
