#!/bin/bash
#SBATCH --job-name=re-gr4j            # Job name
#SBATCH --output=re-gr4j%j.log       # Output file name (%j expands to jobID)
#SBATCH --error=re-gr4j%j.log        # Error file name (%j expands to jobID)
