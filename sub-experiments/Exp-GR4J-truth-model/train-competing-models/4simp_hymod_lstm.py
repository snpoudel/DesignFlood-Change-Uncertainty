...
total_num_basins = os.listdir(f'data/baseline/regional_lstm_simp_hymod/processed_lstm_train_datasets/{pb}/')
x_seq, y_seq = [], []
        ...
        for comb in np.arange(12):
            ...
            if os.path.exists(file_path):
                ...
                simp_hymod_simflow = pd.read_csv(
                    f'output/baseline/simp_hymod/simp_hymod{basin_id}_coverage{coverage}_comb{comb}.csv'
                ...
                output_file_path = f'output/baseline/regional_lstm_simp_hymod/lstm_input{basin_id}_coverage{coverage}_comb{comb}.csv'
