#!/bin/bash
#SBATCH --job-name=infer-hym-lstm            # Job name
#SBATCH --output=infer-hym-lstm%j.log       # Output file name (%j expands to jobID)
#SBATCH --error=infer-hym-lstm%j.log        # Error file name (%j expands to jobID)
#SBATCH --nodes=2                       #3 Number of nodes
...
mpirun python3 5simp_hymod_lstm.py