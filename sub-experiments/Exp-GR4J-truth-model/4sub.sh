#!/bin/bash
#SBATCH --job-name=infer-lstm            # Job name
#SBATCH --output=infer-lstm%j.log       # Output file name (%j expands to jobID)
#SBATCH --error=infer-lstm%j.log        # Error file name (%j expands to jobID)
...
mpirun python3 4regionalLSTM.py